      ...
      <Section id='terms-conditions' className='space-y-8 bg-white text-primary'>
        ...
        <div>
          ...
          <p>
            ...
            acknowledge their understanding of and consent to comply with the terms and conditions
            delineated on this webpage. This agreement reflects the user&apos;s commitment to adhere
        ...
        <div>
          ...
          <p>
            ...
            This encompasses various elements, such as the design, layout, visual aesthetics, and
            overall appearance of the website. It is crucial to understand that any form of
            reproduction or utilization of this material is strictly prohibited, except as
            explicitly permitted by the copyright notice, which constitutes an integral component of
        ...
        <div>
          ...
          <p>
            ...
            website is solely and entirely at your own discretion and risk. We shall not assume any
        ...
        <div>
          ...
          <p>
            ...
            security of our site or its immunity from bugs or viruses. To optimize your experience
            and minimize any potential risks, the responsibility falls on you to configure your
            information technology, computer programs, and platform for seamless access to our site.
            We strongly recommend that you employ your own reliable virus protection software, thus
            adding an extra layer of security to your online interactions with us.
          </p>
        </div>
      </Section>
    </>
