...
export default function WhatWeCanDo() {
  return (
    <Section id='what-we-can-do' className='flex flex-col items-center gap-8'>
      <h2 className='text-secondary'>What we can do</h2>
      <div className='space-y-4 bg-white p-5 text-center text-primary shadow-2xl lg:col-span-4 lg:max-w-5xl lg:p-12 2xl:px-24'>
        <p>
