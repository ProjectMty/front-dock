...
const services = [
  {
    key: 'er',
    icon: (
      <Image src={IconSustainability1} alt='IconSustainability1' width={128} />
    ),
  ...
  },
  {
    key: 'scs',
    icon: (
      <Image src={IconSustainability2} alt='IconSustainability2' width={128} />
    ),
  ...
  },
  {
    key: 'ci',
    icon: (
      <Image src={IconSustainability3} alt='IconSustainability3' width={128} />
    ),
  ...
  },
  {
    key: 'ce',
    icon: (
      <Image src={IconSustainability4} alt='IconSustainability4' width={128} />
    ),
  ...
  },
  {
    key: 'pps',
    icon: (
      <Image src={IconSustainability5} alt='IconSustainability5' width={128} />
    ),
  ...
  },
  {
    key: 'cn',
    icon: (
      <Image src={IconSustainability6} alt='IconSustainability6' width={128} />
    ),
